...
def split_file():
    ...
    chunk_size = int(chunk_size_entry.get()) * 1024  # Convert KB to bytes
...
root = tk.Tk()
root.title('FASTQ File Splitter')
...
split_button = ttk.Button(main_frame, text='Split FASTQ File', command=split_file)
